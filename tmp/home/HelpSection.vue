    ...
    <div class="container">
      <div class="flex flex-col justify-center items-center space-y-20">
        <div class="text-center inline-flex flex-col space-y-8">
          <h3 class="title text-3xl md:text-4xl text-white">{{ title }}</h3>
          <div class="w-full md:w-3/5 mx-auto">
            <p class="description text-base text-gray-300">{{ description }}</p>
          </div>
        </div>
        <div
          class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-y-14 lg:gap-y-0 justify-between items-center w-full"
        >
          <div
